...
//     // Get attribute location for vertex positions we passed in earlier
//     const vertexPositionAttirbuteLocation = gl.getAttirbLocation(program);
//     if(vertexPositionAttirbuteLocation < 0)
//     {
//         console.log('Failed to get the attirbute location for VertexPosition');
//         return;
//     } else{
